            ...
            <div className="flex-1 flex flex-col items-center p-8 gap-6 overflow-y-auto min-h-0">
                ...
                {videoUrl ? (
                    ...
                    <div className="text-neutral-500 text-center">
                        <p>尚未连接视频</p>
                        <p className="text-sm mt-2">连接一个视频节点后即可编辑</p>
                    </div>
                )}
                ...
                {videoUrl && (
                    <div className="w-full max-w-4xl space-y-4 flex-shrink-0">
                        ...
                        <div className="flex justify-between text-sm text-neutral-400">
                            <span className="text-neutral-400">开始：{formatTime(trimStart)}</span>
                            <span className="text-white">当前：{formatTime(currentTime)}</span>
                            <span className="text-neutral-400">结束：{formatTime(trimEnd)}</span>
                        </div>

                        {/* Trim Duration */}
                        <div className="text-center text-neutral-500 text-sm">
                            已选时长：<span className="text-neutral-400 font-medium">{formatTime(trimDuration)}</span>
                        </div>
                    </div>
                )}
            </div>
